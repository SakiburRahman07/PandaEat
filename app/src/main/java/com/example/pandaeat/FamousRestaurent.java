...
public class FamousRestaurent extends AppCompatActivity {
        ListView listView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_famous_restaurent);
    ...
    public void parseData() {
        ...
        String url = "https://api.myjson.online/v1/records/396eb408-5e11-46cb-afad-f83a6b9605ee";
...
//                textView.append("Name : "+jname+", Age : "+jage+", City : "+jcity+"\n\n" );
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    Toast.makeText(FamousRestaurent.this, "Clicked on  : "+names.get(i), Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(FamousRestaurent.this, showfamousrestaurentactivity.class);
