...
public class Delivery_Registration extends AppCompatActivity {
   ...
   // CountryCodePicker Cpp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup = (AppCompatButton) findViewById(R.id.Signupp);
        Emaill = (AppCompatButton) findViewById(R.id.emaillid);
        Phone = (AppCompatButton) findViewById(R.id.Phonenumber);
       ...
       // Cpp = (CountryCodePicker)findViewById(R.id.ctrycode);
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Delivery_Registration.this,MainMenu.class));
                finish();
            }
        });
    }
