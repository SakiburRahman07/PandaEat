...
public class DeliveryShipOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryShipOrderFragmentAdapter.ViewHolder> {
  ...
  //  private APIService apiService;
    ...
    @NonNull
    @Override
    public DeliveryShipOrderFragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DeliveryShipOrderFragmentAdapter.ViewHolder holder, int position) {
        ...
        holder.mobilenumber.setText("+88" + deliveryShipFinalOrders1.getMobileNumber());
