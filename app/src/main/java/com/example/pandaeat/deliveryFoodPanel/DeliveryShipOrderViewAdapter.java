...
public class DeliveryShipOrderViewAdapter extends RecyclerView.Adapter<DeliveryShipOrderViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public DeliveryShipOrderViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DeliveryShipOrderViewAdapter.ViewHolder holder, int position) {
