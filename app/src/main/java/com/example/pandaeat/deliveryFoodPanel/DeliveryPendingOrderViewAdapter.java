...
public class DeliveryPendingOrderViewAdapter extends RecyclerView.Adapter<DeliveryPendingOrderViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public DeliveryPendingOrderViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DeliveryPendingOrderViewAdapter.ViewHolder holder, int position) {
