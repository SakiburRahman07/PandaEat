...
public class DeliveryPendingOrderView extends AppCompatActivity {
    ...
    private void deliveryorders() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child(
                "oCpc4SwLVFbKO0fPdtp4R6bmDmI3").child(RandomUID).child("Dishes");
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child("oCpc4SwLVFbKO0fPdtp4R6bmDmI3").child(RandomUID).child("OtherInformation");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                number.setText("+88" + deliveryShipOrders1.getMobileNumber());
