...
public class CustomerTrackAdapter extends RecyclerView.Adapter<CustomerTrackAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public CustomerTrackAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CustomerTrackAdapter.ViewHolder holder, int position) {
