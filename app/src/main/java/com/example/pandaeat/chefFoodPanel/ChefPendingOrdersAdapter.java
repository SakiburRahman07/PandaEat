...
public class ChefPendingOrdersAdapter extends RecyclerView.Adapter<ChefPendingOrdersAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ChefPendingOrdersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ChefPendingOrdersAdapter.ViewHolder holder, int position) {
        ...
        holder.Reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(context, "Item is rejected, Please refresh for showing updated orders.", Toast.LENGTH_SHORT).show();
