...
import com.example.pandaeat.ChefFoodPanel_BottomNavigation;
...
public class UpdateDelete_Dish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ratingBar=findViewById(R.id.ratingshow);
    ...
    private void updatedesc(String buri) {
        ...
        String ratinstr = String.valueOf(ratingBar.getRating());

        ChefId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        FoodDetails info = new FoodDetails(dishes,quantity,price,description,buri,ID,ChefId,ratinstr);
        firebaseDatabase.getInstance().getReference("FoodDetails").child(State).child(City).child(Area)
