...
public class ChefOrderTobePreparedAdapter extends RecyclerView.Adapter<ChefOrderTobePreparedAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ChefOrderTobePreparedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ChefOrderTobePreparedAdapter.ViewHolder holder, int position) {
