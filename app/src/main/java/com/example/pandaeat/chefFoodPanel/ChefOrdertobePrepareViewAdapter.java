...
public class ChefOrdertobePrepareViewAdapter extends RecyclerView.Adapter<ChefOrdertobePrepareViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ChefOrdertobePrepareViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ChefOrdertobePrepareViewAdapter.ViewHolder holder, int position) {
