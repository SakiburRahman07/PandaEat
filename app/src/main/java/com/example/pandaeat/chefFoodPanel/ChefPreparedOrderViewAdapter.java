...
public class ChefPreparedOrderViewAdapter extends RecyclerView.Adapter<ChefPreparedOrderViewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ChefPreparedOrderViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ChefPreparedOrderViewAdapter.ViewHolder holder, int position) {
