...
public class ChefPreparedOrderAdapter extends RecyclerView.Adapter<ChefPreparedOrderAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ChefPreparedOrderAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ChefPreparedOrderAdapter.ViewHolder holder, int position) {
