...
public class Cheflogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            Signin = (AppCompatButton) findViewById(R.id.button4);
            signup = (TextView) findViewById(R.id.textView3);
            Forgotpassword = (TextView)findViewById(R.id.forgotpasschef);
            Signinphone = (AppCompatButton) findViewById(R.id.btnphone);
            Forgotpassword.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Cheflogin.this, ForgotPassword.class));
                }
            });
                                    ...
                                    databaseReference.child("User").child(user11).child("Role").addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            else
                                            {
                                                ...
                                                Toast.makeText(Cheflogin.this, "This email is already registered with customer or delivery man.", Toast.LENGTH_SHORT).show();
                                            }
...
//                                    if(Fauth.getCurrentUser().isEmailVerified() && flag==false){
//                                        mDialog.dismiss();
//                                        Toast.makeText(Cheflogin.this, "Congratulation! You Have Successfully Login", Toast.LENGTH_SHORT).show();
//                                        Intent Z = new Intent(Cheflogin.this,ChefFoodPanel_BottomNavigation.class);
//                                        startActivity(Z);
